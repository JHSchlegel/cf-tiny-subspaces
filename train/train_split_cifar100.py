...
from utils.data_utils.sequential_CIFAR import CL_CIFAR100
...
# =========================================================================== #
@hydra.main(config_path="../configs", config_name="split_cifar100")
def main(config: DictConfig) -> None:
    ...
    # Create sequential CIFAR100 dataset:
    split_cifar100 = CL_CIFAR100(classes_per_task=config.data.classes_per_task, 
    ...
    try:
        ...
        (
            ...
            trainer.train_and_evaluate(split_cifar100)
        )
